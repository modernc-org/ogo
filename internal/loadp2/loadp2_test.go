...
func TestBuildArgs(t *testing.T) {
	for _, tc := range []struct {
		...
		{
			name: "binary only (default baud applied)",
			o:    Options{Binary: "blink.binary"},
			want: []string{"loadp2", "-b", "230400", "blink.binary"},
		},
		{
