...
// checker -- degenerate constant folding (division or remainder by zero, an
// out-of-range shift count, an operator not defined for the operands) and a
// function type -- and requires that Build handles each without panicking.
