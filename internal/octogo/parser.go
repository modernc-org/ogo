...
const (
	...
	TOK_return       = Symbol(36)  // "return"
	TOK_select       = Symbol(37)  // "select"
	TOK_struct       = Symbol(38)  // "struct"
	TOK_switch       = Symbol(39)  // "switch"
	TOK_type         = Symbol(40)  // "type"
	TOK_var          = Symbol(41)  // "var"
	TOK_007c003d     = Symbol(42)  // "|="
	TOK_007c007c     = Symbol(43)  // "||"
	TOK_0021         = Symbol(44)  // '!'
	TOK_0025         = Symbol(45)  // '%'
	TOK_0026         = Symbol(46)  // '&'
	TOK_0028         = Symbol(47)  // '('
	...
	TOK_007d         = Symbol(65)  // '}'
	TOK_007e         = Symbol(66)  // '~'
	float_lit        = Symbol(67)  // float_lit
	identifier       = Symbol(68)  // identifier
	int_lit          = Symbol(69)  // int_lit
	rune_lit         = Symbol(70)  // rune_lit
	string_lit       = Symbol(71)  // string_lit
	white_space      = Symbol(72)  // white_space
	Type             = Symbol(73)  // Type
	StructType       = Symbol(74)  // StructType
	FieldDecl        = Symbol(75)  // FieldDecl
	InterfaceType    = Symbol(76)  // InterfaceType
	MethodSpec       = Symbol(77)  // MethodSpec
	Block            = Symbol(78)  // Block
	TopLevelDecl     = Symbol(79)  // TopLevelDecl
	VarDecl          = Symbol(80)  // VarDecl
	VarSpec          = Symbol(81)  // VarSpec
	ConstDecl        = Symbol(82)  // ConstDecl
	ConstSpec        = Symbol(83)  // ConstSpec
	TypeDecl         = Symbol(84)  // TypeDecl
	TypeSpec         = Symbol(85)  // TypeSpec
	FuncDecl         = Symbol(86)  // FuncDecl
	Signature        = Symbol(87)  // Signature
	Receiver         = Symbol(88)  // Receiver
	ParameterList    = Symbol(89)  // ParameterList
	IdentifierList   = Symbol(90)  // IdentifierList
	ExpressionList   = Symbol(91)  // ExpressionList
	Expression       = Symbol(92)  // Expression
	SimpleExpr       = Symbol(93)  // SimpleExpr
	Term             = Symbol(94)  // Term
	UnaryExpr        = Symbol(95)  // UnaryExpr
	Factor           = Symbol(96)  // Factor
	FactorSuffix     = Symbol(97)  // FactorSuffix
	Selector         = Symbol(98)  // Selector
	Index            = Symbol(99)  // Index
	FuncLiteral      = Symbol(100) // FuncLiteral
	UnaryOp          = Symbol(101) // UnaryOp
	RelOp            = Symbol(102) // RelOp
	AddOp            = Symbol(103) // AddOp
	MulOp            = Symbol(104) // MulOp
	CallSuffix       = Symbol(105) // CallSuffix
	ArgumentList     = Symbol(106) // ArgumentList
	Statement        = Symbol(107) // Statement
	EmptyStatement   = Symbol(108) // EmptyStatement
	AssignHead       = Symbol(109) // AssignHead
	Postfix          = Symbol(110) // Postfix
	PostfixOp        = Symbol(111) // PostfixOp
	AssignOp         = Symbol(112) // AssignOp
	LhsItem          = Symbol(113) // LhsItem
	ForHeader        = Symbol(114) // ForHeader
	ForClause        = Symbol(115) // ForClause
	ForPost          = Symbol(116) // ForPost
	IfStmt           = Symbol(117) // IfStmt
	SwitchStmt       = Symbol(118) // SwitchStmt
	SwitchGuard      = Symbol(119) // SwitchGuard
	CaseClause       = Symbol(120) // CaseClause
	CaseHead         = Symbol(121) // CaseHead
	SelectStmt       = Symbol(122) // SelectStmt
	CommClause       = Symbol(123) // CommClause
	CommHead         = Symbol(124) // CommHead
	CommOp           = Symbol(125) // CommOp
	PostfixComm      = Symbol(126) // PostfixComm
	SourceFile       = Symbol(127) // SourceFile
	ImportDecl       = Symbol(128) // ImportDecl
	ImportSpec       = Symbol(129) // ImportSpec
)

const SymbolNames = "EOF\"!=\"\"%=\"\"&&\"\"&=\"\"&^=\"\"*=\"\"++\"\"+=\"\"--\"\"-=\"\"/=\"\":=\"\"<-\"\"<<\"\"<<=\"\"<=\"\"==\"\">=\"\">>\"\">>=\"\"^=\"\"break\"\"case\"\"chan\"\"const\"\"continue\"\"default\"\"defer\"\"else\"\"for\"\"func\"\"go\"\"if\"\"import\"\"interface\"\"return\"\"select\"\"struct\"\"switch\"\"type\"\"var\"\"|=\"\"||\"'!''%''&''('')''*''+'',''-''.''/'':'';''<''=''>''['']''^''{''|''}''~'float_litidentifierint_litrune_litstring_litwhite_"

var SymbolIndex = [...]uint16{0, 3, 7, 11, 15, 19, 24, 28, 32, 36, 40, 44, 48, 52, 56, 60, 65, 69, 73, 77, 81, 86, 90, 97, 103, 109, 116, 126, 135, 142, 148, 153, 159, 163, 167, 175, 186, 194, 202, 210, 218, 224, 229, 233, 237, 240, 243, 246, 249, 252, 255, 258, 261, 264, 267, 270, 273, 276, 279, 282, 285, 288, 291, 294, 297, 300, 303, 306, 315, 325, 332, 340, 350, 361, 365, 375, 384, 397, 407, 412, 424, 431, 438, 447, 456, 464, 472, 480, 489, 497, 510, 524, 538, 548, 558, 562, 571, 577, 589, 597, 602, 613, 620, 625, 630, 635, 645, 657, 666, 680, 690, 697, 706, 714, 721, 730, 739, 746, 752, 762, 773, 783, 791, 801, 811, 819, 825, 836, 846, 856, 866}
...
var errorSets = [...][]Symbol{
	...
	{TOK_003d, TOK_003b, TOK_003a003d},
	{TOK_003a003d},
	...
	{UnaryOp, FuncLiteral, Factor, UnaryExpr, Term, SimpleExpr, Expression, string_lit, rune_lit, int_lit, identifier, float_lit, TOK_007e, TOK_007b, TOK_005e, TOK_005b, TOK_003b, TOK_002d, TOK_002b, TOK_002a, TOK_0028, TOK_0026, TOK_0021, TOK_func, TOK_003c002d},
...
//	id  65: \}
//	id  66: ~
//	id  67: ((([0-9]))(((_))?(([0-9])))*)(\.)((([0-9]))(((_))?(([0-9])))*)
//	id  68: ((((\pL))|(_)))((((((\pL))|(_)))|((\p{Nd}))))*
//	id  69: ((((0)|(([1-9]))(((_))?((([0-9]))(((_))?(([0-9])))*))?))|((0)(((b)|(B)))((_))?((((0)|(1)))(((_))?(((0)|(1))))*))|((0)(((o)|(O)))?((_))?((([0-7]))(((_))?(([0-7])))*))|((0)(((x)|(X)))((_))?((([0-9A-Fa-f]))(((_))?(([0-9A-Fa-f])))*)))
...
//			shift and goto state 4
//
// ForClause is used internally from Parse.
func (p *Parser) ForClause() (r []int32) {
	accept, errorSet := false, 0
	r = append(p.get(), -int32(ForClause), 0)
	// state0:
...
//		Accept
//		on  ":=", ';', '='
//			call ForClause and goto state 3
//
...
state5:
	...
	switch Symbol(p.tok.Ch) {
	case TOK_003a003d, TOK_003b, TOK_003d:
		r = p.add(r, p.ForClause())
		goto state3
	}
	return p.stop(r, accept, errorSet)
}
...
state5:
	...
	switch Symbol(p.tok.Ch) {
	case TOK_003c002d, TOK_func, TOK_0021, TOK_0026, TOK_0028, TOK_002a, TOK_002b, TOK_002d, TOK_003b, TOK_005b, TOK_005e, TOK_007e, float_lit, identifier, int_lit, rune_lit, string_lit:
