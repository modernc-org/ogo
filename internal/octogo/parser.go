...
const (
	...
	ExpressionList   = Symbol(92)  // ExpressionList
	Expression       = Symbol(93)  // Expression
	SimpleExpr       = Symbol(94)  // SimpleExpr
	Term             = Symbol(95)  // Term
	UnaryExpr        = Symbol(96)  // UnaryExpr
	Factor           = Symbol(97)  // Factor
	FactorSuffix     = Symbol(98)  // FactorSuffix
	Selector         = Symbol(99)  // Selector
	Index            = Symbol(100) // Index
	FuncLiteral      = Symbol(101) // FuncLiteral
	UnaryOp          = Symbol(102) // UnaryOp
	RelOp            = Symbol(103) // RelOp
	AddOp            = Symbol(104) // AddOp
	MulOp            = Symbol(105) // MulOp
	CallSuffix       = Symbol(106) // CallSuffix
	ArgumentList     = Symbol(107) // ArgumentList
	Statement        = Symbol(108) // Statement
	EmptyStatement   = Symbol(109) // EmptyStatement
	AssignHead       = Symbol(110) // AssignHead
	Postfix          = Symbol(111) // Postfix
	PostfixOp        = Symbol(112) // PostfixOp
	AssignOp         = Symbol(113) // AssignOp
	LhsItem          = Symbol(114) // LhsItem
	ForHeader        = Symbol(115) // ForHeader
	ForRest          = Symbol(116) // ForRest
	ForAssignRest    = Symbol(117) // ForAssignRest
	ForPost          = Symbol(118) // ForPost
	IfStmt           = Symbol(119) // IfStmt
	SwitchStmt       = Symbol(120) // SwitchStmt
	SwitchGuard      = Symbol(121) // SwitchGuard
	CaseClause       = Symbol(122) // CaseClause
	CaseHead         = Symbol(123) // CaseHead
	SelectStmt       = Symbol(124) // SelectStmt
	CommClause       = Symbol(125) // CommClause
	CommHead         = Symbol(126) // CommHead
	CommOp           = Symbol(127) // CommOp
	PostfixComm      = Symbol(128) // PostfixComm
	SourceFile       = Symbol(129) // SourceFile
	ImportDecl       = Symbol(130) // ImportDecl
	ImportSpec       = Symbol(131) // ImportSpec
)

const SymbolNames = "EOF\"!=\"\"%=\"\"&&\"\"&=\"\"&^=\"\"*=\"\"++\"\"+=\"\"--\"\"-=\"\"/=\"\":=\"\"<-\"\"<<\"\"<<=\"\"<=\"\"==\"\">=\"\">>\"\">>=\"\"^=\"\"break\"\"case\"\"chan\"\"const\"\"continue\"\"default\"\"defer\"\"else\"\"for\"\"func\"\"go\"\"if\"\"import\"\"interface\"\"range\"\"return\"\"select\"\"struct\"\"switch\"\"type\"\"var\"\"|=\"\"||\"'!''%''&''('')''*''+'',''-''.''/'':'';''<''=''>''['']''^''{''|''}''~'float_litidentifierint_litrune_litstring_litwhite_"

var SymbolIndex = [...]uint16{0, 3, 7, 11, 15, 19, 24, 28, 32, 36, 40, 44, 48, 52, 56, 60, 65, 69, 73, 77, 81, 86, 90, 97, 103, 109, 116, 126, 135, 142, 148, 153, 159, 163, 167, 175, 186, 193, 201, 209, 217, 225, 231, 236, 240, 244, 247, 250, 253, 256, 259, 262, 265, 268, 271, 274, 277, 280, 283, 286, 289, 292, 295, 298, 301, 304, 307, 310, 313, 322, 332, 339, 347, 357, 368, 372, 382, 391, 404, 414, 419, 431, 438, 445, 454, 463, 471, 479, 487, 496, 504, 517, 531, 545, 555, 565, 569, 578, 584, 596, 604, 609, 620, 627, 632, 637, 642, 652, 664, 673, 687, 697, 704, 713, 721, 728, 737, 744, 757, 764, 770, 780, 791, 801, 809, 819, 829, 837, 843, 854, 864, 874, 884}
