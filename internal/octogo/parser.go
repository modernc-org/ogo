...
const (
	...
	FactorSuffix     = Symbol(100) // FactorSuffix
	Selector         = Symbol(101) // Selector
	Index            = Symbol(102) // Index
	FuncLiteral      = Symbol(103) // FuncLiteral
	UnaryOp          = Symbol(104) // UnaryOp
	RelOp            = Symbol(105) // RelOp
	AddOp            = Symbol(106) // AddOp
	MulOp            = Symbol(107) // MulOp
	CallSuffix       = Symbol(108) // CallSuffix
	ArgumentList     = Symbol(109) // ArgumentList
	Statement        = Symbol(110) // Statement
	EmptyStatement   = Symbol(111) // EmptyStatement
	AssignHead       = Symbol(112) // AssignHead
	Postfix          = Symbol(113) // Postfix
	PostfixOp        = Symbol(114) // PostfixOp
	AssignOp         = Symbol(115) // AssignOp
	LhsItem          = Symbol(116) // LhsItem
	ForHeader        = Symbol(117) // ForHeader
	ForRest          = Symbol(118) // ForRest
	ForAssignRest    = Symbol(119) // ForAssignRest
	ForPost          = Symbol(120) // ForPost
	IfStmt           = Symbol(121) // IfStmt
	SwitchStmt       = Symbol(122) // SwitchStmt
	SwitchGuard      = Symbol(123) // SwitchGuard
	CaseClause       = Symbol(124) // CaseClause
	CaseHead         = Symbol(125) // CaseHead
	SelectStmt       = Symbol(126) // SelectStmt
	CommClause       = Symbol(127) // CommClause
	CommHead         = Symbol(128) // CommHead
	CommOp           = Symbol(129) // CommOp
	PostfixComm      = Symbol(130) // PostfixComm
	SourceFile       = Symbol(131) // SourceFile
	ImportDecl       = Symbol(132) // ImportDecl
	ImportSpec       = Symbol(133) // ImportSpec
)

const SymbolNames = "EOF\"!=\"\"%=\"\"&&\"\"&=\"\"&^=\"\"*=\"\"++\"\"+=\"\"--\"\"-=\"\"/=\"\":=\"\"<-\"\"<<\"\"<<=\"\"<=\"\"==\"\">=\"\">>\"\">>=\"\"^=\"\"break\"\"case\"\"chan\"\"const\"\"continue\"\"default\"\"defer\"\"else\"\"for\"\"func\"\"go\"\"if\"\"import\"\"interface\"\"range\"\"return\"\"select\"\"struct\"\"switch\"\"type\"\"var\"\"|=\"\"||\"'!''%''&''('')''*''+'',''-''.''/'':'';''<''=''>''['']''^''{''|''}''~'float_litidentifierint_litrune_litstring_litwhite_"

var SymbolIndex = [...]uint16{0, 3, 7, 11, 15, 19, 24, 28, 32, 36, 40, 44, 48, 52, 56, 60, 65, 69, 73, 77, 81, 86, 90, 97, 103, 109, 116, 126, 135, 142, 148, 153, 159, 163, 167, 175, 186, 193, 201, 209, 217, 225, 231, 236, 240, 244, 247, 250, 253, 256, 259, 262, 265, 268, 271, 274, 277, 280, 283, 286, 289, 292, 295, 298, 301, 304, 307, 310, 313, 322, 332, 339, 347, 357, 368, 372, 382, 391, 404, 414, 419, 431, 438, 445, 454, 463, 471, 479, 487, 496, 504, 517, 527, 536, 550, 564, 574, 584, 588, 597, 603, 615, 623, 628, 639, 646, 651, 656, 661, 671, 683, 692, 706, 716, 723, 732, 740, 747, 756, 763, 776, 783, 789, 799, 810, 820, 828, 838, 848, 856, 862, 873, 883, 893, 903}
...
var errorSets = [...][]Symbol{
	...
	{UnaryOp, FuncLiteral, Factor, UnaryExpr, Term, SimpleExpr, Expression, string_lit, rune_lit, int_lit, identifier, float_lit, TOK_007e, TOK_007b, TOK_005e, TOK_005b, TOK_003b, TOK_002d, TOK_002b, TOK_002a, TOK_0028, TOK_0026, TOK_0021, TOK_range, TOK_func, TOK_003c002d},
	{UnaryOp, FuncLiteral, Factor, UnaryExpr, Term, SimpleExpr, string_lit, rune_lit, int_lit, identifier, float_lit, TOK_007e, TOK_005e, TOK_005b, TOK_003b, TOK_002d, TOK_002b, TOK_002a, TOK_0028, TOK_0026, TOK_0021, TOK_range, TOK_func, TOK_003c002d},
	{UnaryOp, FuncLiteral, Factor, UnaryExpr, Term, SimpleExpr, Expression, string_lit, rune_lit, int_lit, identifier, float_lit, TOK_007e, TOK_005e, TOK_005b, TOK_002d, TOK_002b, TOK_002a, TOK_0028, TOK_0026, TOK_0021, TOK_range, TOK_func, TOK_003c002d},
	{UnaryOp, FuncLiteral, Factor, UnaryExpr, Term, SimpleExpr, string_lit, rune_lit, int_lit, identifier, float_lit, TOK_007e, TOK_005e, TOK_005b, TOK_002d, TOK_002b, TOK_002a, TOK_0028, TOK_0026, TOK_0021, TOK_range, TOK_func, TOK_003c002d},
	...
	{UnaryOp, FuncLiteral, Factor, UnaryExpr, Term, SimpleExpr, string_lit, rune_lit, int_lit, identifier, float_lit, TOK_007e, TOK_005e, TOK_005b, TOK_003b, TOK_002d, TOK_002b, TOK_002a, TOK_0028, TOK_0026, TOK_0021, TOK_func, TOK_003c002d},
